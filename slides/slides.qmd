...
* After creating an account and joining the workspace, click on `Content > New project`
* You can either select a blank RStudio project, or `New project from template`
